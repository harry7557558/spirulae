...

{
  ...
  if (!b.quiet) {
    ...
    printf(" milliseconds:  %d\n", (int)(1000l * (tv2.tv_sec - tv1.tv_sec) +
  ...
  if (!b.quiet) {
    gettimeofday(&tv4, &tz);
    if (b.poly && !b.refine) {
      printf("Hole milliseconds:  %d\n", (int)(1000l * (tv4.tv_sec - tv3.tv_sec) +
...
#ifndef NO_TIMER
    gettimeofday(&tv6, &tz);
    printf("\nOutput milliseconds:  %d\n", (int)(
           1000l * (tv6.tv_sec - tv5.tv_sec) +
           (tv6.tv_usec - tv5.tv_usec) / 1000l));
    printf("Total running milliseconds:  %d\n", (int)(
